	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#C5F6AD" class="title">
					<td height="14" colspan="10" class="top">&nbsp;注册用户维护&nbsp;</td>
				</tr>
				...
				<s:iterator value="#request" id="user">
			...
			<!--分页 -->
						<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
							<ul class="pagination"
								...
								<c:if test="${pageBean.currentPage!=1 }">
									<li><a
										href="${pageContext.request.contextPath}/userMana.action?currentPage=${pageBean.currentPage-1 }"
								...
								<c:forEach begin="1" end="${pageBean.totalPage }" var="page">
									...
									<c:if test="${pageBean.currentPage!=page }">
										<li><a
											href="${pageContext.request.contextPath}/userMana.action?currentPage=${page }">${page }</a></li>
									</c:if>
								</c:forEach>
